...
export function StudentDashboardPage() {
  ...
  useEffect(() => {
    void Promise.all([
      ...
      notificationService.studentAnnouncements(),
      notificationService.notifications(),
    ]).then(([nextSubjects, nextAnnouncements, nextNotifications]) => {
      setSubjects(nextSubjects);
      setAnnouncements(nextAnnouncements.slice(0, 4));
  ...
  return (
    <div>
      <div className="page-heading">
        ...
        <p>Your class activity at a glance.</p>
      </div>
