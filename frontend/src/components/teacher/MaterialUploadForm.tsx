...
import type { LearningMaterialResponse, MaterialUploadProgress } from "@/types";
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-slate-500">
        Files are sent directly to MinIO in resilient 5 MiB parts. Each part
      ...
      {success && (
        <div className="mt-4">
          <ApiAlert message={success} tone="success" />
        </div>
      )}
