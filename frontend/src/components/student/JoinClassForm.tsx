...
export function JoinClassForm({ onSubmitted }: { onSubmitted: (request: ClassEnrollmentRequestResponse) => void }) {
  ...
  return (
    <form className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm" onSubmit={submit}>
      ...
      <p className="mt-1 text-sm text-slate-500">Ask your adviser for the six-character class code.</p>
